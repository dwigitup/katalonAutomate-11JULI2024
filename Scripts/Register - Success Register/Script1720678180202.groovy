...
WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'dwi11@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'g/RPTFVaM+A=')
